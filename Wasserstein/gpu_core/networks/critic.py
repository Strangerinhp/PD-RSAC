...
class Critic(nn.Module):
    ...
    def _encode_assignments(
        ...
        """Encode assignments into per-vehicle vector (VECTORIZED - NO LOOPS).
        
        CRITICAL FIX: Maintain per-vehicle information instead of averaging.
        PERFORMANCE FIX: Fully vectorized - no Python loops over batch/vehicles.
        ...
        # Encode charge assignments with per-vehicle positioning (VECTORIZED)
